...
speech_key, service_region = "YOUR_AZURE_API_KEY", "YOUR_SERVICE_REGION"
speech_config = speechsdk.SpeechConfig(subscription=speech_key, region=service_region)
audio_config = speechsdk.audio.AudioConfig(device_name="YOUR_DEVICE_NAME")   # 집
################### set API keys ends
...
# Making the 'logs' and 'Data_result' folders if they do not exist
folders = ["./logs/", "./Data_result/", "./Data_result/Script/"]
...
# read settings from 'settings.txt' file
language =  input("type 'eng' or 'kor': ").lower()
if language == 'eng':
    THIS_LANGUAGE = 'en-US'
    print("ENG start!")
else:
...
last_index = {key: 0 for key in list(RESPONSE_UTTS.keys())}
